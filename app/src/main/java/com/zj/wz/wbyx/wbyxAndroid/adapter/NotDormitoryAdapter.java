...
public class NotDormitoryAdapter extends RecyclerView.Adapter<NotDormitoryAdapter.ViewHolder> {

    private List<NotDormitoryAddress> addressList = new ArrayList<>();
    ...
    public NotDormitoryAdapter(Context mContext, List<NotDormitoryAddress> dormitoryAddressList
    ...
    public interface OnDoritoryItemClick{
        void setDefaultClick(NotDormitoryAddress dormitoryAddress);         //设为默认
        void onWriteClick(NotDormitoryAddress dormitoryAddress);            //编辑
        void onDeleteClick(NotDormitoryAddress dormitoryAddress);           //删除
        void onItemClick(NotDormitoryAddress notDormitoryAddress);             //整个item选择
    }
}
