...
import static com.zj.wz.wbyx.baseandroid.config.Constant.AFTER_SALES_ORDER;
 ...
 * Description: 售后订单fragment
 */

public class AfterSalesOrderFragment extends BaseMvpFragment<OrderView, OrderPresenter>
    ...
    protected void setupView(View rootView) {
        ...
        smartOrder.setOnRefreshLoadMoreListener(new OnRefreshLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                page ++ ;
                getPresenter().getOrder(AFTER_SALES_ORDER,page,PAGE_NUM);
            }
