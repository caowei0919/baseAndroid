...
/**
 * FileName: CommonFragmentAdapter
 * Author: 曹伟
 * Date: 2019/10/22 14:15
 * Description:订单页面适配器
 */

public class CommonFragmentAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener{
    ...
    public CommonFragmentAdapter(FragmentManager fragmentManager, ViewPager viewPager
