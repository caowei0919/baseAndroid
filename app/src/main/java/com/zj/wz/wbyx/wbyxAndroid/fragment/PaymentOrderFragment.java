...
import static com.zj.wz.wbyx.baseandroid.config.Constant.PAYMENT_ORDER;

/**
 * FileName: HomeFragment
 * Author: 曹伟
 * Date: 2019/9/20 20:25
 * Description: 待付款订单fragment
 */

public class PaymentOrderFragment extends BaseMvpFragment<OrderView, OrderPresenter>
    ...
    protected void setupView(View rootView) {
        ...
        smartOrder.setOnRefreshLoadMoreListener(new OnRefreshLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                page ++ ;
                getPresenter().getOrder(PAYMENT_ORDER,page,PAGE_NUM);
            }
