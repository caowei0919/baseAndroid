...
import com.zj.wz.wbyx.wbyxAndroid.presenter.HomeOfAllPresenter;
...
/**
 * FileName: HomeOfAllFragment
 * Author: 曹伟
 * Date: 2019/11/8 10:21
 * Description:首页底部全部
 */

public class HomeOfAllFragment extends BaseMvpFragment<HomeOfAllView, HomeOfAllPresenter>
        implements HomeOfAllView, HomeGoodsAdapter.OnAddToShopCarClick {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_home_of_all;
    }
    ...
    protected void setupView(View rootView) {
        ...
        smartAll.setOnLoadMoreListener(new OnLoadMoreListener() {
            @Override
