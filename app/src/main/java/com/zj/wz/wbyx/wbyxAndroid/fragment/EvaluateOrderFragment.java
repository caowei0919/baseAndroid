...
import static com.zj.wz.wbyx.baseandroid.config.Constant.EVALUATE_ORDER;
 ...
 * Description: 待评价fragment
 */

public class EvaluateOrderFragment extends BaseMvpFragment<OrderView, OrderPresenter>
    ...
    protected void setupView(View rootView) {
        ...
        smartOrder.setOnRefreshLoadMoreListener(new OnRefreshLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                page ++ ;
                getPresenter().getOrder(EVALUATE_ORDER,page,PAGE_NUM);
            }
