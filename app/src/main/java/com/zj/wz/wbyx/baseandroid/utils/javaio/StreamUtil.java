package com.zj.wz.wbyx.baseandroid.utils.javaio;
...
public class StreamUtil {
    ...
    public static int copy(InputStream input, OutputStream output) throws IOException {
        final int ioBufferSize = JoddIoDefault.ioBufferSize;
    ...
    public static void copy(InputStream input, Writer output) throws IOException {
        copy(input, output, JoddIoDefault.encoding);
    }
    ...
    public static void copy(InputStream input, Writer output, int byteCount) throws
            IOException {
        copy(input, output, JoddIoDefault.encoding, byteCount);
    }
    ...
    public static void copy(Reader input, OutputStream output, int charCount) throws
            IOException {
        copy(input, output, JoddIoDefault.encoding, charCount);
    }
