...
import static com.zj.wz.wbyx.baseandroid.config.Constant.ALL_ORDER;
 ...
 * Description: 全部订单fragment
 */

public class AllOrderFragment extends BaseMvpFragment<OrderView, OrderPresenter>
    ...
    protected void setupView(View rootView) {
        ...
        smartOrder.setOnRefreshLoadMoreListener(new OnRefreshLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                page ++ ;
                getPresenter().getOrder(ALL_ORDER,page,PAGE_NUM);
            }
