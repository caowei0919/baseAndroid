...
import com.zj.wz.wbyx.wbyxAndroid.presenter.HomeOfMarketPresenter;
import com.zj.wz.wbyx.wbyxAndroid.view.HomeOfMarketView;
...
/**
 * FileName: HomeOfMarketFragment
 * Author: 曹伟
 * Date: 2019/11/8 10:25
 * Description:首页底部超市
 */

public class HomeOfMarketFragment extends BaseMvpFragment<HomeOfMarketView, HomeOfMarketPresenter>
        implements HomeOfMarketView, HomeGoodsAdapter.OnAddToShopCarClick {
    @BindView(R.id.smart_market)
    SmartRefreshLayout smartMarket ;
    ...
    protected int getLayoutId() {
        return R.layout.fragment_home_of_market;
    }
    ...
    protected void setupView(View rootView) {
        ...
        smartMarket.setOnLoadMoreListener(new OnLoadMoreListener() {
            @Override
    ...
    protected void setupData(Bundle savedInstanceState) {
        goodsType = Constant.HOME_GOODS_MARKET ;
    }
