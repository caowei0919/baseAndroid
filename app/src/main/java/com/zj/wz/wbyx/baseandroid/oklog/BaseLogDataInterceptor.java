...
/**
 * FileName: BaseLogDataInterceptor
 * Author: 曹伟
...
public abstract class BaseLogDataInterceptor<Chain, Request, Response, Headers, MediaType> {
    ...
    protected abstract void writeRequestBody(Request request, Buffer buffer) throws
            IOException;

    protected abstract BufferedSource responseBodySource(Response response) throws
            IOException;
    ...
    @NonNull
    public ResponseLogData<Response> processResponse(LogDataBuilder logDataBuilder, Response response) throws
            IOException {
