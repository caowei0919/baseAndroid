...
import static com.zj.wz.wbyx.baseandroid.config.Constant.SEND_ORDER;
...
public class SendOrderFragment extends BaseMvpFragment<OrderView, OrderPresenter>
    ...
    protected void setupView(View rootView) {
        ...
        smartOrder.setOnRefreshLoadMoreListener(new OnRefreshLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                page ++ ;
                getPresenter().getOrder(SEND_ORDER,page,PAGE_NUM);
            }
