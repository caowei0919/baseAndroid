...
/**
 * FileName: HomeOfRecommendPresenter
 * Author: 曹伟
 * Date: 2019/11/8 10:30
 * Description:首页底部推荐P层
 */

public class HomeOfRecommendPresenter extends BasePresenter<HomeOfRecommendView> {
    MyApi api ;

    @Inject
    public HomeOfRecommendPresenter(MyApi api) {
        this.api = api;
    }
