...
import com.zj.wz.wbyx.wbyxAndroid.presenter.RecommendPresenter;
import com.zj.wz.wbyx.wbyxAndroid.utils.GoodsAnimUtil;
import com.zj.wz.wbyx.wbyxAndroid.view.RecommendView;
...
import static com.zj.wz.wbyx.baseandroid.config.Constant.TYPE_RECOMMEND;

/**
 * FileName: RecommendActivity
 * Author: 曹伟
 * Date: 2019/11/9 10:00
 * Description:推荐商城
 */

public class RecommendActivity extends BaseMvpActivity<RecommendView, RecommendPresenter>
        implements RecommendView, MarketIndicatorTopAdapter.onIndicatorTopClick
        , MarketIndicatorAdapter.onIndicatorClick, MarketFragment.OnAddToShopInFragmentClick {
    ...
    protected void setupView() {
        ...
        tvTltle.setText(mContext.getResources().getString(R.string.nest_side_recommended));
        /**
         * 获取banner底部位置
         */
    ...
    public void initMagicIndicator(){
        ...
        wrapGoods.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                getPresenter().getGoodList(area_id,cart_id,Constant.TYPE_GOODS_RECOMMEND);
            }
    ...
    protected void setupData(Bundle savedInstanceState) {
        ...
        type = Constant.TYPE_GOODS_RECOMMEND ;
        getPresenter().getAdv(TYPE_RECOMMEND);
    ...
    public void getMenuSuccess(MenuItemListBean response) {
        ...
        for (int i = 0 ; i < menuItemBeans.size() ; i ++){
            fragments.add(MarketFragment.newInstance(menuItemBeans.get(i),Constant.TYPE_GOODS_RECOMMEND));
        }
